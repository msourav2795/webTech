...
public class Employee extends AbstractEmployee{
    ...
    Employee(String fName,String mName,String lName,String c){
        firstName=fName;
        middleName=mName;
        lastName=lName;
        contact=c;
    }
    Employee(String fName,String mName,String lName,double s){
        firstName=fName;
        middleName=mName;
        lastName=lName;
        salary=s;
    }
    Employee(int id,String fName,String mName,String lName,String d,String t,String c, double s){
        employeeId=id;
        firstName=fName;
        middleName=mName;
        lastName=lName;
